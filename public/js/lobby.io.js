const $$$ = {
    ...
    enter : function(id, code, name) {
        return new Promise((resolve, reject) => {
        this.socket.emit("join_lobby", {id, code, name}, (err, msg) => {
            err ? reject({err, msg}) : resolve(msg);
        })
    })},
    ...
    create : function(id, name) {
        return  new Promise((resolve, reject) => {
        this.socket.emit("create_lobby", {id, name}, (err, msg) => {
            err ? reject({err, msg}) : resolve(msg);
        });
    })},
    ...
    getNames : function (id) {
        return new Promise((resolve, reject) => {
            this.socket.emit("get_names", {id}, (err, msg) => {
                err ? reject(err, msg) : resolve(msg);
            });
        });
    },
